...
import sys
sys.path.append('/mnt/4T/SYN/HRDA_my')
import argparse
import os
...
def parse_args():
    ...
    parser.add_argument('--config', default='/mnt/4T/SYN/HRDA_my/configs/daformer/syn2cs_uda_warm_fdthings_rcs_croppl_a999_daformer_mitb5_s0.py',help='test config file path')
    parser.add_argument('--checkpoint',default="/mnt/4T/SYN/HRDA_my/work_dirs/syn2cs_uda_warm_fdthings_rcs_croppl_a999_daformer_mitb5_s0/52.9.pth", help='checkpoint file')
    parser.add_argument(
    ...
    parser.add_argument(
        '--show-dir', default='/mnt/4T/SYN/HRDA_my/pred_ss/daformer_my_syn',help='directory where painted images will be saved')
    parser.add_argument(
        '--gpu-collect',
        action='store_true',
    ...
    parser.add_argument(
        '--tmpdir',
        default='/mnt/4T/SYN/HRDA_my/pred_ss/daformer_my_syn',
