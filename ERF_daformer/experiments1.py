...
def get_model_base(architecture, backbone):
    ...
    if "Headone" in architecture and 'mitb5' in backbone:
        return f'_base_/models/{architecture}_mitb5.py'
    if "SegFormerHead" in architecture and 'mitb5' in backbone:
        return f'_base_/models/{architecture}_mitb5.py'
...
def generate_experiment_cfgs(id):
    ...
    # -------------------------------------------------------------------------
        ...
        architecture, backbone = ('Headone', 'mitb5')
        uda = 'dacs_a999_fdthings'
        rcs_T = 0.01
        plcrop = True
        for (source, target), seed in \
        ...
        architecture, backbone = ('SegFormerHead', 'mitb5')
        uda = 'dacs_a999_fdthings'
        rcs_T = 0.01
        plcrop = True
        for (source, target), seed in \
